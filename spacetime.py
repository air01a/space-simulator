...
class SpaceTime:
    ...
    def __init__2(self, control_info=None):
        ...
        moon.set_orbit_parameters(
            constants.earth_mu, 384000 * 1000, 0, pi, pi, 0, 2.91 * pi / 3
        )
        ...
        self.controller = Controller(
            "missions/apollo/apollo.orbit", self.orbiters, self.time_controller
        )
        ...
        orbiter.r = Vector(
            -2440038.190849225, 6300272.642030265, -7.715608724818002e-10
        )
