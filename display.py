...
class Display():
    ...
    def __init__(self, event_listener, zoom_ratio=1):
        ...
        self.moon_picture = pygame.transform.scale(self.moon_main_sprite, (round(DEFAULT_EARTH_SIZE*self.zoom_ratio*0.27)+1, round(DEFAULT_EARTH_SIZE*self.zoom_ratio)+1))
